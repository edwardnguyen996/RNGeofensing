...
public class MainActivity extends ReactActivity implements OnCompleteListener<Void>, MSREventBridgeEventReceiver {
    ...
    public void onEvent(final String name, final ReadableMap info) {
        ...
        if (name.equals("StartGenfensingTracking")) {
            addGeofencesButtonHandler();
            return;
        }
        if (name.equals("StopGenfensingTracking")) {
    ...
    @Override
    public void onEventCallback(final String name, final ReadableMap info,
                                final MSREventBridgeReceiverCallback callback) {
        return;
    }
            ...
            new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if (location != null) {
                        ...
                        addGeofences();
                        showSnackbar(getString(R.string.started_to_tracking_genfensing));
                    }
                }
            }
        );
    ...
    public void removeGeofencesButtonHandler() {
        ...
        removeGeofences();
        showSnackbar(getString(R.string.stopped_to_tracking_genfensing));
    }
